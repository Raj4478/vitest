...
Custom environments are also measured under both VM pools. If an environment does not provide `setupVM`, those candidates are reported as failed and are not recommended.
